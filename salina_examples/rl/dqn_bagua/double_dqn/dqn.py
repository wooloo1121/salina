...
def run_dqn(q_agent, logger, cfg):
    ...
    if q_agent_args['type'] == 0:
        ...
        q_agent.cnn.advantage = q_agent.cnn.advantage.with_bagua([optimizer], gradient_allreduce.GradientAllReduceAlgorithm())
        q_agent.cnn.value = q_agent.cnn.value.with_bagua([optimizer], gradient_allreduce.GradientAllReduceAlgorithm())
